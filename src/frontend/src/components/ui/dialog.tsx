...
const DialogPortal = ({
  ...
  <DialogPrimitive.Portal {...props}>
    <div
      className={cn(
        "nopan nodelete nodrag noflow fixed inset-0 z-[9999] flex items-center justify-center",
        className,
      )}
    >
      {children}
...
>(({ className, lightBlur = false, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      lightBlur
        ? dialogClass.dialogContentLightBlur
