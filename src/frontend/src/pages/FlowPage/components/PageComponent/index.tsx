      ...
      {showCanvas ? (
        <ResizableSplitter
          ...
          onResize={(topHeight, bottomHeight) => {
            console.log("Resized:", { topHeight, bottomHeight });
            // Update map height to trigger map refresh
            setMapHeight(`${bottomHeight}px`);
          }}
        >
          {/* Upper section - ReactFlow Canvas */}
              ...
              <div className="h-full bg-card rounded-lg border shadow-sm">
                <MapComponent
                  ...
                  onRegionSelect={(coordinates) => {
                    console.log("Selected region:", coordinates);
                    // Here you can handle the selected region coordinates
                    // For example, store them in a state or send to a parent component
                  }}
                />
              </div>
            </div>
